...
export const { globalCss, css, getCssText, createTheme } = createStitches({
    theme: {
        colors: {
        ...
        fonts: {
            display:
                "Space Mono, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica Neue, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol",
            text: "Inter, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica Neue, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol",
